...
class model_translate:
    ...
    def get_models(self, src="fr", trg="en"):
        ...
        return tokenizer_lang_detect, model_lang_detect, tokenizer_trans, model_trans


def detect_language(text):
    tokenizer_lang_detect, model_lang_detect, tokenizer_trans, model_trans = model_translate().get_models()
